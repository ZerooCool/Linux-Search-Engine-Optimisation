...
# Rapatrier Joomla! 3.9.1.1 qui est la dernière version stable lors de la rédaction de ce tutoriel.
wget https://github.com/AFUJ/joomla-cms-fr/releases/download/3.9.1.1/Joomla_3.9.1-FR-Stable-Full_Package.zip

echo " "

# Dézipper l'archive zip au même niveau.
echo "Dézipper Joomla! dans le répertoire courant /var/www/html/"
unzip Joomla_3.9.1-FR-Stable-Full_Package.zip
# Supprimer l'archive zip.
rm Joomla_3.9.1-FR-Stable-Full_Package.zip
