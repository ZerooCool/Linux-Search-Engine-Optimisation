...
echo "Appuyer sur une touche pour mettre à jour des dépôts de debian."
apt update

# Installer les paquets nécessaires pour le serveur web local.
echo "Appuyer sur une touche pour installer les paquets nécessaires pour le serveur web local."
apt install nano wget unzip apache2 php7.0 php7.0-curl mariadb-server mariadb-client

# Démarrer MariaDB.
echo "Appuyer sur une touche pour démarrer MariaDB."
/etc/init.d/mysql start

# Installer PHPMyAdmin.
echo "Appuyer sur une touche pour installer PHPMyAdmin."
apt install phpmyadmin
# yes pour configurer phpmyadmin
# Choisir un mot de passe : GestionnaireBDD

# Démarrer Apache2.
echo "Appuyer sur une touche pour démarrer Apache2."
service apache2 start

# Se placer dans le dossier par défaut du serveur web local.
echo "Appuyer sur une touche pour se placer dans le dossier par défaut du serveur web local."
cd /var/www/html
# Créer un dossier hello.
echo "Appuyer sur une touche pour créer un dossier hello."
mkdir hello
# Se placer dans le dossier hello.
echo "Appuyer sur une touche pour aller dans le dossier hello."
cd /var/www/html/hello

# Créer le fichier hello.php pour vérifier le fonctionnement de PHP.
echo "Appuyer sur une touche pour créer le fichier hello.php pour vérifier le fonctionnement de PHP."
echo "<?php" >> hello.php
echo "echo 'SEO';" >> hello.php
echo "?>" >> hello.phpn

# Créer le fichier phpinfo.php pour obtenir les informations du serveur.
echo "Appuyer sur une touche pour créer le fichier phpinfo.php pour obtenir les informations du serveur."
echo "<?php" >> phpinfo.php
echo "phpinfo();" >> phpinfo.php
echo "?>" >> phpinfo.php

# Créer le fichier curl.php pour vérifier si cURL est activé.
echo "Appuyer sur une touche pour créer le fichier curl.php pour vérifier si cURL est activé."
echo "<?php" >> curl.php
...
echo "Appuyer sur une touche pour se connecter en root à MariaDB."
mysql -u root -p
...
echo "Appuyer sur une touche pour se placer à la racine du dossier html et charger Joomla!"
cd /var/www/html/
...
echo "Appuyer sur une touche pour dézipper Joomla!"
